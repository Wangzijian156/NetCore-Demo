...
namespace ND.Common
{
    ...
    public static partial class Extend
    {
        ...
        public static string ToSex(this bool value) => value ? "男" : "女";
        /// <summary>
        /// 转换为性别
        /// </summary>
        /// <param name="value">数据</param>
        public static string ToSex(this int value) => value == 1 ? "男" : value == 0 ? "女" : "";
        /// <summary>
        /// 转换为性别
        /// </summary>
        /// <param name="value">数据</param>
        public static string ToSex(this int? value) => value == null ? "" : ToSex(value.Value);
        /// <summary>
        /// 转换为描述性语言
        /// </summary>
        /// <param name="value">数据</param>
